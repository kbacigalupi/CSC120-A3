...
_____ (Kudos!) Handles mirror words with punctuation Nope :/

__MAYBE___ (Kudos!) Generates output with correct punctuation & capitalization Kinda 

___YES__ (Kudos!) Handles you --> me/I dilemma Kind of? 
...
___YES__ 2 pt: Complies with style guidelines (missing items 1 pt each):
      ...
      _____ Classes & class members all have Javadoc header comments **(I think so)**
